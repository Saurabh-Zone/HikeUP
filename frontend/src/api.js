const BASE = import.meta.env.VITE_API_URL || (import.meta.env.PROD ? "https://hikeup-d40e.onrender.com/api" : "/api");
...
export async function api(endpoint, options = {}) {
  ...
  try {
    ...
    throw new Error(
      "Cannot connect to HikeUp backend. Please ensure you have an active internet connection and the server is running."
    );
  }
